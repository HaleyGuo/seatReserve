...
public interface ReservationMapper {
    ...
    //检查预约情况,只允许预约一个座位
    public reservation CheckReservation(@Param("username") String username);
    //预约座位
    ...
    //退选座位
    public boolean DeleteReservation(@Param("username") String username);
    //查询个人预约记录
    public List<reservation> SelectReservationLog(@Param("username") String username);
    //签到
    public boolean SignIn(@Param("username") String username);
}
